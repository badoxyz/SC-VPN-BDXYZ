...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/vpn.sh && chmod +x vpn.sh && ./vpn.sh
...
wget -O member "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/member.sh"
wget -O delete "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/delete.sh"
wget -O cek "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/cek.sh"
wget -O restart "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/restart.sh"
wget -O speedtest "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/info.sh"
wget -O ram "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/ram.sh"
wget -O renew "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/renew.sh"
wget -O autokill "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/autokill.sh"
wget -O ceklim "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/ceklim.sh"
wget -O tendang "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/tendang.sh"
wget -O clear-log "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/clear-log.sh"
wget -O change-port "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/change.sh"
wget -O port-ovpn "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-ovpn.sh"
wget -O port-ssl "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-ssl.sh"
wget -O port-wg "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-wg.sh"
wget -O port-tr "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-tr.sh"
wget -O port-sstp "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-sstp.sh"
wget -O port-squid "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-squid.sh"
wget -O port-ws "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-ws.sh"
wget -O port-vless "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/port-vless.sh"
...
mkdir /var/lib/premium-script;
echo "IP=" >> /var/lib/premium-script/ipvps.conf
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install v2ray
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
clear
...
echo "   - WS non TLS              : 2095"  | tee -a log-install.txt
echo "   - WS TLS/SSL              : 443"  | tee -a log-install.txt
echo "   - WS OVPN                 : 2082"  | tee -a log-install.txt
