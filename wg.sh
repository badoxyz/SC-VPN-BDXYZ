...
echo -e "${Info} Wireguard Script By Badoxyz"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/badoxyz/SC-VPN-BDXYZ/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
